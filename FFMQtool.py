...
dialogues: list = [
    ...
    (0x1C3E0, 0x1C3F2), (0x1C40D, 0x1C467), (0x1C49F, 0x1C4A7), (0x1C4A8, 0x1C4C5), (0x1C509, 0x1C52B),
    ...
    (0x1CCDB, 0x1CD33), (0x1CE3C, 0x1CE4F), (0x1CE5B, 0x1CE74), (0x1CEA2, 0x1CEB8), (0x1CED4, 0x1CEE5),
    ...
    (0x1DA77, 0x1DA81), (0x1DA92, 0x1DACB), (0x1DADF, 0x1DAEC), (0x1DB22, 0x1DB95), (0x1DB9F, 0x1DBBF),
    ...
    (0x1D2EF, 0x1D2F4), (0x1D2F5, 0x1D301), (0x1D30C, 0x1D315), (0x1D316, 0x1D321), (0x1D32C, 0x1D330),
    ...
    (0x1D3C9, 0x1D3CE), (0x1D3CF, 0x1D3D2), (0x1D3D3, 0x1D3D6), (0x1D3D7, 0x1D3E1), (0x1D3E2, 0x1D3EB),
    (0x1D3FF, 0x1D410), (0x1D411, 0x1D424), (0x1D425, 0x1D42C), (0x1D42D, 0x1D43A), (0x1D43B, 0x1D442),
    (0x1D443, 0x1D446), (0x1D451, 0x1D457), (0x1D458, 0x1D463), (0x1D464, 0x1D46D), (0x1D46E, 0x1D477),
    (0x1D478, 0x1D483), (0x1D484, 0x1D48F), (0x1D490, 0x1D49B), (0x1D49C, 0x1D4A6), (0x1D4A7, 0x1D4B1),
    (0x1D4B2, 0x1D4BD), (0x1D4BE, 0x1D4CE), (0x1D4CF, 0x1D4DE), (0x1D4DF, 0x1D4F0), (0x1D4F1, 0x1D4FD),
    (0x1D4FE, 0x1D506), (0x1D507, 0x1D514), (0x1D515, 0x1D529), (0x1D52A, 0x1D538), (0x1D539, 0x1D54C),
        ...
        try:
            ...
            if b1 in mte_tbl:
                ...
                if b1 == 0x1A and char in special_tbl:
                    ...
                    i += 1
                elif b1 in (0x1A, 0x1B, 0x1D, 0x1E, 0x1F, 0x20) and char not in special_tbl:
